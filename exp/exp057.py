...
class CommonLitModule(LightningModule):
    def __init__(self,
        ...
        self.self_attn = nn.MultiheadAttention(self.bert.config.hidden_size, num_heads=self.cfg.num_heads)
