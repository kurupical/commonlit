...
if __name__ == "__main__":
    experiment_name = "いろいろなmodel with pretrained"
    folds = [0, 1, 2, 3, 4]
    ...
    for model in ["finetuned_model/roberta_base_5_tune",
                  "finetuned_model/roberta_base_10_tune",
                  "finetuned_model/roberta_base_15_tune",
                  ]:
        for lr_bert in [5e-5]:
            cfg = Config(experiment_name=experiment_name)
            cfg.fine_tuned_path = model
