        ...
        for fold in folds:
            try:
                ...
                if cfg.nlp_model_name in ["roberta-large",
                    ...
                    if fold == 0 and rmse > 0.4625:
                        break
                    if fold == 1 and rmse / 2 > 0.46:
                        break
...
if __name__ == "__main__":
    ...
    for nlp_model_name in ["studio-ousia/luke-large"]:
        ...
        cfg.nlp_model_name = nlp_model_name
        cfg = common_config(cfg)
        cfg.rnn_hidden_indice = (5, 11, 17, 23)
        main(cfg, folds=folds)
        ...
        cfg.nlp_model_name = nlp_model_name
        cfg = common_config(cfg)
        cfg.rnn_module_shrink_ratio = 0.125
        main(cfg, folds=folds)
        ...
        cfg.nlp_model_name = nlp_model_name
        cfg = common_config(cfg)
        cfg.attention_head_enable = True
        main(cfg, folds=folds)
